...
public class OutCheckActivity extends BaseActivity{

	private OutCheckListViewAdapter adapter;
	...
	private Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg) {
			if (msg.what==1) {
				check_bar();
				SQLiteHelper sqLiteHelper = new SQLiteHelper(OutCheckActivity.this);
	...
	private void initView() {
		// TODO Auto-generated method stub
		listView = (ListView) findViewById(R.id.outcheck_lv);
		editText = (EditText) findViewById(R.id.outcheck_et);
		...
		adapter = new OutCheckListViewAdapter(articles, OutCheckActivity.this);
